# SAM Serverless Samples: rest-hello
...
curl https://ulgpuwhw90.execute-api.us-east-1.amazonaws.com/Prod/hello/
```
...
```bash
sam logs -n HelloWorldFunction --stack-name sam-samples-rest-hello --tail
```
...
Tests are defined in the `hello-world/tests` folder in this sample. Use NPM to install the [Mocha test framework](https://mochajs.org/) and run unit tests.
